...
{
    instruction_t opcodes[14] = {{"push", push_s}, {"pall", pall}, {"pint", pint}, {"pop", pop}, {"swap", swap}, {"add", add}, {"sub", sub}, {"divv", divv}, {"mul", mul}, {"mod", mod}, {"pChar", pChar}, {"pStr", pStr}, {"rotl", rotl}, {"rotr", rotr}};
